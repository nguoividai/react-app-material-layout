    ...
    */
    ...
    const singleLogo = (
      <svg
        ...
        width="100%"
        height="100%"
        viewBox="0 0 500.000000 430.000000"
      ...
      >
        ...
        >
          <path
            d="M292 4011 l-114 -6 64 -90 c64 -90 123 -171 464 -635 99 -135 212
-291 252 -347 40 -56 76 -105 82 -108 5 -3 20 32 34 77 31 103 202 739 255
948 l39 155 -82 7 c-96 7 -831 6 -994 -1z"
          />
          <path
            d="M2698 4013 c-43 -2 -78 -6 -78 -10 0 -9 166 -244 409 -576 125 -172
303 -417 396 -544 l170 -233 580 0 c322 0 586 4 594 9 16 10 -22 64 -637 904
l-334 457 -512 -2 c-281 -1 -546 -4 -588 -5z"
          />
          <path
            d="M750 1564 c0 -3 77 -110 170 -237 94 -128 256 -349 360 -492 105
-143 248 -338 317 -432 l127 -173 599 0 c329 0 597 4 595 8 -1 5 -221 307
-488 670 l-485 662 -597 0 c-329 0 -598 -3 -598 -6z"
          />
        </g>
      </svg>
    );
